...
?>
	...
	<div class="container">
        ...
        <div>
            <table class="table table-hover table-sm table-striped table-condensed table-bordered table-#6c757d">
        ...
        <div class="col-6">
            ...
            <button class="btn" name="submit" type="submit" id="myBtn" style="background-color:#1EA6C6;">Transfer Amount</button>
            </div>
        </form>
    </div>
